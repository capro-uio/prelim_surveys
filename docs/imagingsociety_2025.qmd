...
Of the `r nrow(dt)` responses, `r cur_mri` participants reported they currently use MRI for research, `r scales::percent(cur_mri / nrow(dt))` indicate a future interest in using the new MRI facility for their work.
