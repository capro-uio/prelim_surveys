  ...
  tryCatch(
    {
      ...
      combined_text <- paste0(text_vector, collapse = " ")
...
Of the `r nrow(dt)` responses, `r cur_mri` participants reported they currently use MRI for research. The majority of respondents, `r scales::percent(cur_mri / nrow(dt))`, indicated a future interest in using the new MRI facility for their work.
